        ...
        <section id='education' className='w-full about capitalize h-fit p-5 grid mt-10 gap-15 md:gap-0 grid-cols-1'>
            <div className='w-full p-5 md:p-0 grid grid-cols-1 md:grid-cols-3'>
                ...
                <div className='relative hidden md:flex justify-center overflow-hidden'>
                    ...
                    <div className='w-[0.5px] bg-black dark:bg-white absolute h-full hidden md:block top-0 bottom-0'></div>
                </div>
            ...
            <div className='p-5 md:p-0 relative hidden md:flex h-40 justify-center overflow-hidden'>
                <div className='w-[0.5px] dark:bg-white bg-black absolute h-full hidden md:block top-0 bottom-0'></div>
            </div>
            ...
            <div className='p-5 md:p-0 w-full grid grid-cols-1 md:grid-cols-3'>
                ...
                <div className='grid gap-5 grid-cols-1'>
                    ...
                    <span className='text-neutral-600 dark:text-neutral-400'>Earned the Moroccan high school diploma in Life and Earth Sciences.</span>
                </div>
            </div>
        </section>
    </>)
