...
const Footer = () => {
  return (
    <footer className='w-full capitalize sora flex flex-col h-fit mt-10 p-1 bg-black text-white'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-10 p-5 items-center '>
            ...
            <span className='flex center items-center justify-center'><GithubIcon className='mr-2.5' height='40px' width='40px' /><a href="http://">GitHub repository</a></span>
        </div>
    </footer>
  )
}
