    ...
    return (<>
        <nav className='w-full navbar flex justify-between items-center h-fit px-2.5 py-5 duration-700 sm:p-8'>
            ...
            <div className={sideMenuStyle}>
                <button onClick={() => showSideMenu((prevState) => !prevState)} className='absolute hover:cursor-pointer top-0 right-0 p-5'><CloseIcon className='ml-1.5' /></button>
                ...
                <button className='flex bg-white hover:bg-gray-300 duration-700 text-black w-fit rounded items-center p-2 my-4 mx-2 sm:m-5'>Resume <DownloadIcon className='ml-1.5 w-3 h-3' /></button>
            </div>
        </nav>
    </>)
}
